    ...
    return (
        <section id="about" className="py-16 md:py-24 bg-white relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                ...
                <div className="absolute top-[20%] right-[-10%] w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-[#8E44AD]/[0.02] rounded-full blur-[80px] md:blur-[120px]" />

                {/* Minimalist Pattern */}
                <div className="absolute inset-0 opacity-[0.03]"
                    style={{
                        backgroundImage: 'radial-gradient(#8E44AD 0.8px, transparent 0.8px)',
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    >
                        <div className="text-[#8E44AD] text-xs md:text-sm font-bold tracking-widest uppercase mb-4">About Us</div>
                        ...
                        <div className="flex items-center gap-4 bg-white px-5 md:px-6 py-3 md:py-4 rounded-2xl w-max border border-slate-100 shadow-sm">
                            <div>
                                ...
                                <div className="text-[#8E44AD] text-[10px] md:text-sm font-bold uppercase tracking-widest">Founder</div>
                            </div>
                        </div>
                    </motion.div>
