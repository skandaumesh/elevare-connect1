                ...
                <div className="grid lg:grid-cols-2 gap-16">
                        ...
                        <form className="space-y-6">
                            <div className="grid sm:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" className="w-full bg-[#F5F3FF] border border-transparent focus:border-[#6E2690] focus:ring-0 rounded-xl px-4 py-3 outline-none transition-colors" placeholder="John Doe" />
                                </div>
                                <div>
                                    <label className="block text-sm font-bold text-[#0D0D0D] mb-2">Email</label>
                                    <input type="email" className="w-full bg-[#F5F3FF] border border-transparent focus:border-[#6E2690] focus:ring-0 rounded-xl px-4 py-3 outline-none transition-colors" placeholder="john@example.com" />
                                </div>
                            </div>
                            <div className="grid sm:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm font-bold text-[#0D0D0D] mb-2">Phone</label>
                                    <input type="tel" className="w-full bg-[#F5F3FF] border border-transparent focus:border-[#6E2690] focus:ring-0 rounded-xl px-4 py-3 outline-none transition-colors" placeholder="+91 XXXXX XXXXX" />
                                </div>
                                <div>
                                    <label className="block text-sm font-bold text-[#0D0D0D] mb-2">College / Organisation</label>
                                    <input type="text" className="w-full bg-[#F5F3FF] border border-transparent focus:border-[#6E2690] focus:ring-0 rounded-xl px-4 py-3 outline-none transition-colors" placeholder="Institution Name" />
                                </div>
                            </div>
                            <div>
                                <label className="block text-sm font-bold text-[#0D0D0D] mb-2">Message</label>
                                <textarea rows={4} className="w-full bg-[#F5F3FF] border border-transparent focus:border-[#6E2690] focus:ring-0 rounded-xl px-4 py-3 outline-none transition-colors resize-none" placeholder="How can we help you?" />
                            </div>
                    ...
                    >
                        <div className="bg-white p-8 rounded-3xl shadow-sm border border-[rgba(0,0,0,0.07)] flex items-start gap-6 hover:shadow-md transition-shadow">
                            <div className="w-14 h-14 bg-[#F5F3FF] rounded-2xl flex items-center justify-center flex-shrink-0 text-[#6E2690]">
                                <Mail size={24} />
                            </div>
                            <div>
