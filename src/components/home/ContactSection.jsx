        ...
        <section id="contact" className="py-24 bg-[#FFFFFF]">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid lg:grid-cols-2 gap-16">
                    ...
                    >
                        <h2 className="text-[#1E293B] text-3xl font-bold mb-2 tracking-tight">Let&apos;s Connect</h2>
                        ...
                        <form className="space-y-6">
                            ...
                            <div className="grid sm:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label className="block text-sm font-bold text-[#1E293B] mb-2">College / Organisation</label>
                    ...
                    >
                        <div className="bg-white p-8 rounded-3xl shadow-sm border border-[rgba(0,0,0,0.07)] flex items-start gap-6 hover:shadow-md transition-shadow">
                            <div className="w-14 h-14 bg-[#FDFBFF] rounded-2xl flex items-center justify-center flex-shrink-0 text-[#1E293B]">
                                <Mail size={24} />
                            </div>
                            <div>
                                <div className="text-[#1E293B] font-bold text-xl mb-1">Email Us</div>
                                <p className="text-[#52525B] font-medium leading-relaxed">Drop us a line and we&apos;ll get back to you immediately.</p>
                                <a href="mailto:info@elevareconnect.in" className="text-[#1E293B] font-bold block mt-2 hover:underline">info@elevareconnect.in</a>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-8 rounded-3xl shadow-sm border border-[rgba(0,0,0,0.07)] flex items-start gap-6 hover:shadow-md transition-shadow">
                            ...
                            <div>
                                <div className="text-[#1E293B] font-bold text-xl mb-1">Call Us</div>
                                <p className="text-[#52525B] font-medium leading-relaxed">We&apos;re available Monday to Friday, 9:00 AM - 6:00 PM.</p>
                                <a href="tel:+919999999999" className="text-[#1E293B] font-bold block mt-2 hover:underline">+91 XXXXX XXXXX</a>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-8 rounded-3xl shadow-sm border border-[rgba(0,0,0,0.07)] flex items-start gap-6 hover:shadow-md transition-shadow">
                            ...
                            <div>
                                <div className="text-[#1E293B] font-bold text-xl mb-1">Visit Us</div>
