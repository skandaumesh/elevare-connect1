...
export default function HeroSection() {
  return (
    <section className="relative w-full h-[100vh] min-h-[600px] flex items-center overflow-hidden bg-white">
      ...
      <div className="absolute top-1/4 -left-20 w-[500px] h-[500px] bg-[#8E44AD]/5 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 -right-20 w-[400px] h-[400px] bg-[#8E44AD]/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="inline-flex mb-8">
            <span className="px-5 py-2.5 rounded-full bg-[#8E44AD] text-white text-[10px] md:text-sm font-black tracking-[0.15em] uppercase shadow-xl shadow-[#8E44AD]/20">
              Elevare Connect
            </span>
          </div>
          ...
          <h1 className="text-[#0D0D0D] text-3xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 leading-[1.1] uppercase [text-shadow:0_1px_2px_rgba(255,255,255,0.8)]">
            ...
            <span className="text-[#8E44AD]">its Direction.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-start gap-4 md:gap-6">
            <a href="/services" className="w-full sm:w-auto px-8 md:px-10 py-3.5 md:py-4 bg-[#8E44AD] text-white font-bold rounded-xl hover:bg-[#662483] transition-all text-center tracking-wide uppercase text-xs md:text-sm shadow-xl hover:-translate-y-0.5">
              Discover More
            </a>
