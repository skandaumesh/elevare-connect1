  ...
  return (
    <section className="relative w-full py-12 md:py-16 overflow-hidden bg-[#0D0B26]">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-[#662483]/10 rounded-full blur-[100px]" />
        
        {/* Modern Geometric Line Design (Sine Waves) */}
        <svg className="absolute top-0 right-0 w-full md:w-2/3 h-full text-[#662483]/20" viewBox="0 0 400 400" preserveAspectRatio="none">
        ...
        <div className="absolute inset-0 opacity-[0.02]" style={{ backgroundImage: 'radial-gradient(#662483 1px, transparent 1px)', backgroundSize: '30px 30px' }} />
      </div>
...
function StatItem({ icon, label, target, suffix }) {
  ...
  return (
    <div ref={ref} className="group relative flex flex-col items-center justify-center p-10 rounded-[40px] bg-white/[0.03] backdrop-blur-xl border border-white/10 hover:bg-white/[0.08] transition-all duration-700 shadow-2xl">
      <div className="text-white mb-6 p-4 rounded-3xl bg-white/5 border border-white/10 group-hover:bg-[#662483] group-hover:border-[#662483] transition-all duration-500 transform group-hover:scale-110">
        {icon}
      </div>
