...
export default function WhyElevareSection() {
    const cards = [
        {
            icon: <BookOpen size={32} className="text-[#8E44AD]" />,
        ...
        <section className="py-24 bg-[#F8FAFC] relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                ...
                <div className="absolute top-0 left-0 w-full h-full opacity-[0.15]"
                    style={{
                        backgroundImage: `radial-gradient(at 0% 0%, #8E44AD 0, transparent 50%), 
                              radial-gradient(at 100% 0%, #8E44AD 0, transparent 50%),
                              radial-gradient(at 100% 100%, #8E44AD 0, transparent 50%),
                              radial-gradient(at 0% 100%, #8E44AD 0, transparent 50%)`
                    }}
                />
                ...
                <motion.div
                    ...
                    className="absolute top-20 left-[10%] w-64 h-64 bg-[#8E44AD]/5 rounded-full blur-3xl"
                />
                <motion.div
                    animate={{
                        y: [0, 20, 0],
                    ...
                    className="absolute bottom-20 right-[10%] w-96 h-96 bg-[#8E44AD]/5 rounded-full blur-3xl"
                />
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                >
                    <div className="inline-block px-4 py-1.5 mb-4 text-[#8E44AD] text-xs font-bold tracking-[0.2em] uppercase bg-[#8E44AD]/10 rounded-full">
                        Why Choose Us
                    </div>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {cards.map((card, idx) => (
                        ...
                        >
                            ...
                            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#8E44AD] to-purple-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500" />

                            <div className="relative z-10">
                                <div className="w-16 h-16 rounded-2xl bg-[#F5F3FF] flex items-center justify-center mb-6 group-hover:bg-[#8E44AD] group-hover:text-white transition-colors duration-300">
