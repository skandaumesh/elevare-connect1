    ...
    return (
        <section className="py-24 bg-[#F8FAFC] relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                <div className="absolute top-[10%] left-[-5%] w-[400px] h-[400px] bg-[#662483]/[0.03] rounded-full blur-[120px]" />
            ...
            <div className="max-w-[1200px] mx-auto px-6 relative z-10">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-4 text-[#662483] text-[10px] font-bold tracking-[0.25em] uppercase bg-purple-50/50 border border-purple-100/50 rounded-full">
                    ...
                    <h2 className="text-[#0f172a] text-4xl md:text-[44px] font-bold tracking-tight">
                        Program Add-Ons & <span className="text-[#662483]">Enrichments</span>
                    </h2>
                </motion.div>
