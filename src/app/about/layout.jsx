export const metadata = {
    ...
    keywords: ["Elevare Connect Founder", "HR Professional India", "Career Readiness Expert", "Campus Mentorship Bengaluru", "Leadership Training", "Soft Skills Training Bengaluru"],
    openGraph: {
