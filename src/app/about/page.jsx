    ...
    return (
        <div className="relative min-h-screen bg-[#F9F8F3] overflow-hidden pt-20 md:pt-28">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                ...
                <div className="absolute top-[5%] left-[-5%] w-[400px] md:w-[800px] h-[400px] md:h-[800px] bg-[#6E2690]/5 rounded-full blur-[100px] md:blur-[160px]" />
                <div className="absolute bottom-[5%] right-[-5%] w-[400px] md:w-[800px] h-[400px] md:h-[800px] bg-[#6E2690]/5 rounded-full blur-[100px] md:blur-[160px]" />

                {/* Subtle Modern Grid Overlay */}
                <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: 'linear-gradient(#6E2690 1px, transparent 1px), linear-gradient(90deg, #6E2690 1px, transparent 1px)', backgroundSize: '100px 100px' }} />
            </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
                        ...
                        >
                            <div className="relative">
                                ...
                                <div className="absolute inset-0 bg-[#6E2690]/10 rounded-full blur-[60px] transform translate-y-8" />
            ...
            <section className="px-6 py-20 md:py-32 relative bg-[#F9F8F3] overflow-hidden">
                ...
                <div className="absolute inset-0 pointer-events-none z-0">
                    ...
                    <div className="absolute bottom-0 left-[-10%] w-[500px] h-[500px] bg-[#6E2690]/[0.08] rounded-full blur-[120px]" />
                    <svg className="absolute inset-0 w-full h-full opacity-[0.03]" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <pattern id="dot-pattern" width="30" height="30" patternUnits="userSpaceOnUse">
                                <circle cx="2" cy="2" r="1.5" fill="#6E2690" />
                            </pattern>
                        </defs>
                        ...
                        {[
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl flex items-center justify-center bg-[#F5F3FF] text-[#6E2690] mb-6 md:mb-8 shadow-inner group-hover:bg-[#6E2690] group-hover:text-white transition-colors duration-500 relative z-10">
            ...
            <section className="px-6 py-24 md:py-40 bg-white relative overflow-hidden">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-4 md:gap-5">
                        ...
                        <Link href="/services" className="w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 rounded-full bg-white border border-slate-200 text-[#0D0D0D] font-bold text-xs md:text-sm tracking-[0.2em] uppercase transition-all hover:border-[#6E2690] hover:text-[#6E2690]">
                            Our Services
                        </Link>
                    </div>
                </motion.div>
