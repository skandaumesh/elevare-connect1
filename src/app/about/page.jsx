                        ...
                        {[
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="absolute -bottom-8 -right-8 w-32 h-32 bg-[#FDFBFF] rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-0" />
                                </motion.div>
                            );
                        })}
                    </div>
