    ...
    return (
        <div className="relative min-h-screen bg-[#F9F8F3] overflow-hidden pt-20 md:pt-28">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                ...
                <div className="absolute top-[5%] left-[-5%] w-[400px] md:w-[800px] h-[400px] md:h-[800px] bg-[#8E44AD]/5 rounded-full blur-[100px] md:blur-[160px]" />
                <div className="absolute bottom-[5%] right-[-5%] w-[400px] md:w-[800px] h-[400px] md:h-[800px] bg-[#8E44AD]/5 rounded-full blur-[100px] md:blur-[160px]" />

                {/* Subtle Modern Grid Overlay */}
                <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: 'linear-gradient(#8E44AD 1px, transparent 1px), linear-gradient(90deg, #8E44AD 1px, transparent 1px)', backgroundSize: '100px 100px' }} />
            </div>
            ...
            <section className="relative pt-16 md:pt-20 pb-16 md:pb-24 overflow-hidden">
                <div className="max-w-6xl mx-auto px-6 relative z-10 text-center">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 md:px-5 py-1.5 md:py-2 mb-6 md:mb-8 rounded-full bg-[#8E44AD]/10 text-[#8E44AD] text-[10px] md:text-sm font-bold tracking-widest uppercase">
                        ...
                        <h1 className="text-[#0D0D0D] text-3xl md:text-5xl lg:text-7xl font-extrabold tracking-tight mb-6 md:mb-8 leading-[1.1] font-['Roboto',sans-serif]">
                            ...
                            <span className="text-[#8E44AD]">Human-Centric Skills.</span>
                        </h1>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 md:gap-20 justify-center w-full max-w-3xl">
                            {[
                                ...
                                <div key={idx} className="flex flex-col items-center">
                                    ...
                                    <p className="text-[#8E44AD] font-bold text-[10px] md:text-xs tracking-[0.2em] uppercase">{s.l}</p>
                                </div>
                            ))}
                        </div>
                    </motion.div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
                        ...
                        >
                            <h2 className="text-[#0f172a] text-3xl md:text-[46px] font-bold mb-8 md:mb-10 tracking-tight leading-[1.2] font-['Roboto',sans-serif]">
                                ...
                                <span className="text-[#8E44AD]">Behind Elevare Connect</span>
                            </h2>
                            ...
                            <div className="mt-8 md:mt-10 pt-6 md:pt-8 border-t border-slate-100 flex items-center justify-center lg:justify-start gap-4">
                                <div className="hidden md:block w-10 h-[2px] bg-[#8E44AD]" />
                        ...
                        >
                            <div className="relative">
                                ...
                                <div className="absolute inset-0 bg-[#8E44AD]/10 rounded-full blur-[60px] transform translate-y-8" />
            ...
            <section className="px-6 py-20 md:py-32 relative bg-[#F9F8F3] overflow-hidden">
                ...
                <div className="absolute inset-0 pointer-events-none z-0">
                    <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#8E44AD]/5 rounded-full blur-[100px] md:blur-[150px]" />
                    <div className="absolute bottom-0 left-[-10%] w-[500px] h-[500px] bg-[#8E44AD]/[0.08] rounded-full blur-[120px]" />
                    <svg className="absolute inset-0 w-full h-full opacity-[0.03]" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <pattern id="dot-pattern" width="30" height="30" patternUnits="userSpaceOnUse">
                                <circle cx="2" cy="2" r="1.5" fill="#8E44AD" />
                            </pattern>
                        </defs>
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-5 py-2 mb-6 rounded-full bg-[#8E44AD]/10 text-[#8E44AD] text-[10px] md:text-sm font-bold tracking-widest uppercase shadow-sm">
                        ...
                        <h2 className="text-[#0D0D0D] text-4xl md:text-6xl font-black tracking-tight mb-6 font-['Roboto',sans-serif]">
                            Why <span className="text-[#8E44AD]">Elevare Connect.</span>
                        </h2>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            return (
                                ...
                                >
                                    {/* Hover gradient line */}
                                    <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-[#8E44AD] to-purple-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />
                                    
                                    <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl flex items-center justify-center bg-[#F5F3FF] text-[#8E44AD] mb-6 md:mb-8 shadow-inner group-hover:bg-[#8E44AD] group-hover:text-white transition-colors duration-500 relative z-10">
            ...
            <section className="px-6 py-24 md:py-40 bg-white relative overflow-hidden">
                <div className="absolute top-0 right-[-10%] w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-[#8E44AD]/10 rounded-full blur-[100px] md:blur-[140px] pointer-events-none" />
                <motion.div
                ...
                >
                    <h2 className="text-[#0D0D0D] text-4xl md:text-7xl font-bold tracking-tight mb-8 leading-[1.1] font-['Roboto',sans-serif]">
                        Collaborate <br />
                        <span className="text-[#8E44AD]">with us today.</span>
                    </h2>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-4 md:gap-5">
                        <Link href="/contact" className="w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 rounded-full bg-[#8E44AD] text-white font-bold text-xs md:text-sm tracking-[0.2em] uppercase transition-all hover:bg-[#662483] group shadow-xl shadow-[#8E44AD]/20">
                            Get Started <ArrowRight className="inline-block ml-2 w-4 h-4 transition-transform group-hover:translate-x-1" />
                        </Link>
                        <Link href="/services" className="w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 rounded-full bg-white border border-slate-200 text-[#0D0D0D] font-bold text-xs md:text-sm tracking-[0.2em] uppercase transition-all hover:border-[#8E44AD] hover:text-[#8E44AD]">
                            Our Services
                        </Link>
                    </div>
                </motion.div>
