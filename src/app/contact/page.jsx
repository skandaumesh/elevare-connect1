                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
                    ...
                    >
                        ...
                        <div className="space-y-2">
                            ...
                            <a href="mailto:info@elevareconnect.in" className="text-[#662483] text-lg md:text-xl font-medium hover:underline break-all">
                    ...
                    >
                        <h2 className="text-[#662483] text-2xl md:text-3xl font-bold text-center mb-8 md:mb-12 font-['Roboto',sans-serif]">
                        ...
                        <form className="space-y-6 md:space-y-8" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <button className="w-full py-4 md:py-5 bg-[#662483] text-white font-bold text-lg md:text-xl rounded-2xl hover:bg-purple-800 transition-all shadow-lg hover:shadow-purple-200">
                                Send
                            </button>
                        </form>
                    </motion.div>
