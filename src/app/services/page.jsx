    ...
    return (
        <div className="relative bg-white min-h-screen overflow-hidden pt-20 md:pt-28">
                ...
                <div className="max-w-5xl mx-auto text-center relative z-10">
                    ...
                    >
                        ...
                        <h1 className="text-[#0f172a] text-3xl md:text-5xl lg:text-6xl font-black tracking-tight mb-6 md:mb-8 leading-[1.1] font-['Roboto',sans-serif]">
                            ...
                            <span className="text-[#662483]">Professional</span> Futures.
                        </h1>
                    ...
                    return (
                        ...
                        >
                            ...
                            >
                                ...
                                {/* Badge Icon */}
                                <div className="absolute top-6 left-6 md:top-10 md:left-10 w-12 h-12 md:w-16 md:h-16 rounded-[16px] md:rounded-[24px] bg-white/95 backdrop-blur-3xl flex items-center justify-center text-[#662483] shadow-2xl transition-transform duration-700 group-hover:scale-110">
                            ...
                            <div className="w-full lg:w-1/2 space-y-6 md:space-y-10">
                                ...
                                <div className="grid gap-3">
                                    {s.points.map((p, pIdx) => (
                                        ...
                                        >
                                            <div className="w-6 h-6 rounded-lg bg-[#662483]/10 flex items-center justify-center flex-shrink-0 transition-colors duration-300 group-hover/item:bg-[#662483] group-hover/item:text-white">
                                ...
                                <motion.div
                                    ...
                                    viewport={{ once: true }}
                                >
                                    <Link href="/contact" className="inline-flex items-center gap-3 text-[#662483] font-bold text-lg hover:gap-6 transition-all duration-500 group">
            ...
            <section className="px-6 pb-16 md:pb-32 relative z-10">
                <div className="max-w-7xl mx-auto overflow-hidden rounded-[32px] md:rounded-[48px] bg-[#662483] text-white p-8 md:p-20 shadow-2xl relative">
                    {/* Decorative Mesh */}
            ...
            <section className="px-6 py-20 md:py-40 relative">
                <div className="max-w-5xl mx-auto relative z-10 text-center">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.8 }}
                        className="relative overflow-hidden rounded-[40px] md:rounded-[56px] bg-[#2B0E38] p-10 md:p-24"
                    >
                        <div className="absolute top-0 right-0 w-[400px] md:w-[800px] h-[400px] md:h-[800px] bg-[#662483]/10 rounded-full blur-[80px] md:blur-[140px] pointer-events-none" />
                        ...
                        <div className="relative z-10 max-w-xl mx-auto">
                            <h2 className="text-white text-3xl md:text-5xl font-bold tracking-tight mb-6 md:mb-8">
                                ...
                                Join <span className="text-[#662483]">Elevare Connect?</span>
                            </h2>
                            ...
                            <Link href="/contact" className="inline-flex items-center gap-3 px-8 md:px-10 py-4 md:py-5 rounded-full bg-[#662483] text-white font-bold text-sm tracking-[0.2em] uppercase transition-all hover:bg-[#4A1561] hover:-translate-y-1 hover:shadow-2xl shadow-[#662483]/40">
