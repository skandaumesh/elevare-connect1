                ...
                <div className="max-w-5xl mx-auto text-center relative z-10">
                    ...
                    >
                        ...
                        <h1 className="text-[#0f172a] text-3xl md:text-5xl lg:text-7xl font-black tracking-tight mb-6 md:mb-8 leading-[1.1] font-['Roboto',sans-serif]">
                            ...
                            <span className="text-[#8E44AD]">Our Impact.</span>
                        </h1>
                ...
                <div className="max-w-5xl mx-auto relative z-10 text-center">
                    ...
                    >
                        <h2 className="text-[#0f172a] text-3xl md:text-6xl font-black tracking-tight mb-6 md:mb-8 leading-[1.1] font-['Roboto',sans-serif]">
                            ...
                            <span className="text-[#8E44AD]">Your Campus.</span>
                        </h2>
                        ...
                        <Link href="/contact" className="inline-flex items-center gap-4 px-10 md:px-14 py-5 md:py-6 rounded-2xl bg-[#3D154F] text-white font-bold text-xs md:text-sm tracking-[0.2em] uppercase transition-all hover:bg-[#8E44AD] hover:-translate-y-1 group shadow-2xl shadow-slate-200">
                ...
                {selectedImg && (
                    ...
                    >
                        ...
                        >
                            ...
                            <button
                                className="absolute top-4 right-4 md:top-8 md:right-8 w-10 h-10 md:w-16 md:h-16 rounded-full bg-[#3D154F] text-white flex items-center justify-center hover:bg-[#8E44AD] hover:scale-110 transition-all shadow-2xl cursor-pointer pointer-events-auto"
                                onClick={() => setSelectedImg(null)}
                            >
